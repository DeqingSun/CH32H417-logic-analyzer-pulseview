...
const ConfigKey ConfigKey::_MULTIPLEXER = ConfigKey(SR_CONF_MULTIPLEXER, "MULTIPLEXER");
...
const ConfigKey ConfigKey::_ADC_PRECISION = ConfigKey(SR_CONF_ADC_PRECISION, "ADC_PRECISION");
const ConfigKey ConfigKey::_ADC_CHANNEL = ConfigKey(SR_CONF_ADC_CHANNEL, "ADC_CHANNEL");
...
const ConfigKey ConfigKey::_HOT_PLUG = ConfigKey(SR_CONF_HOT_PLUG, "HOT_PLUG");
const ConfigKey ConfigKey::_TRIGGER_OFFSET = ConfigKey(SR_CONF_TRIGGER_OFFSET, "TRIGGER_OFFSET");
const ConfigKey ConfigKey::_THRESHOLD_VALUE_1 = ConfigKey(SR_CONF_THRESHOLD_VALUE_1, "THRESHOLD_VALUE_1");
const ConfigKey ConfigKey::_THRESHOLD_VALUE_2 = ConfigKey(SR_CONF_THRESHOLD_VALUE_2, "THRESHOLD_VALUE_2");
const ConfigKey ConfigKey::_REPEAT_ACQUISITION = ConfigKey(SR_CONF_REPEAT_ACQUISITION, "REPEAT_ACQUISITION");
const ConfigKey ConfigKey::_HARDWARE_VERSION = ConfigKey(SR_CONF_HARDWARE_VERSION, "HARDWARE_VERSION");
const ConfigKey ConfigKey::_USB_VERSION = ConfigKey(SR_CONF_USB_VERSION, "USB_VERSION");
const ConfigKey ConfigKey::_SEGMENT_CLEAR = ConfigKey(SR_CONF_SEGMENT_CLEAR, "SEGMENT_CLEAR");
...
const ConfigKey * const ConfigKey::MULTIPLEXER = &ConfigKey::_MULTIPLEXER;
...
const ConfigKey * const ConfigKey::ADC_PRECISION = &ConfigKey::_ADC_PRECISION;
const ConfigKey * const ConfigKey::ADC_CHANNEL = &ConfigKey::_ADC_CHANNEL;
...
const ConfigKey * const ConfigKey::HOT_PLUG = &ConfigKey::_HOT_PLUG;
const ConfigKey * const ConfigKey::TRIGGER_OFFSET = &ConfigKey::_TRIGGER_OFFSET;
const ConfigKey * const ConfigKey::THRESHOLD_VALUE_1 = &ConfigKey::_THRESHOLD_VALUE_1;
const ConfigKey * const ConfigKey::THRESHOLD_VALUE_2 = &ConfigKey::_THRESHOLD_VALUE_2;
const ConfigKey * const ConfigKey::REPEAT_ACQUISITION = &ConfigKey::_REPEAT_ACQUISITION;
const ConfigKey * const ConfigKey::HARDWARE_VERSION = &ConfigKey::_HARDWARE_VERSION;
const ConfigKey * const ConfigKey::USB_VERSION = &ConfigKey::_USB_VERSION;
const ConfigKey * const ConfigKey::SEGMENT_CLEAR = &ConfigKey::_SEGMENT_CLEAR;
template<> const SR_API std::map<const enum sr_configkey, const ConfigKey * const> EnumValue<ConfigKey, enum sr_configkey>::_values = {
	...
	{SR_CONF_MULTIPLEXER, ConfigKey::MULTIPLEXER},
	...
	{SR_CONF_ADC_PRECISION, ConfigKey::ADC_PRECISION},
	{SR_CONF_ADC_CHANNEL, ConfigKey::ADC_CHANNEL},
	...
	{SR_CONF_HOT_PLUG, ConfigKey::HOT_PLUG},
	{SR_CONF_TRIGGER_OFFSET, ConfigKey::TRIGGER_OFFSET},
	{SR_CONF_THRESHOLD_VALUE_1, ConfigKey::THRESHOLD_VALUE_1},
	{SR_CONF_THRESHOLD_VALUE_2, ConfigKey::THRESHOLD_VALUE_2},
	{SR_CONF_REPEAT_ACQUISITION, ConfigKey::REPEAT_ACQUISITION},
	{SR_CONF_HARDWARE_VERSION, ConfigKey::HARDWARE_VERSION},
	{SR_CONF_USB_VERSION, ConfigKey::USB_VERSION},
	{SR_CONF_SEGMENT_CLEAR, ConfigKey::SEGMENT_CLEAR},
};
#include <config.h>
