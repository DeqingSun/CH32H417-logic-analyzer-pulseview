...
enum sr_configkey {
	...
	SR_CONF_HOT_PLUG,
	SR_CONF_TRIGGER_OFFSET,
	SR_CONF_THRESHOLD_VALUE_1,
	SR_CONF_THRESHOLD_VALUE_2,
	SR_CONF_REPEAT_ACQUISITION,
	SR_CONF_HARDWARE_VERSION,
	SR_CONF_USB_VERSION,
	SR_CONF_SEGMENT_CLEAR,
};
...
struct sr_dev_driver {
	...
	int (*dev_channel_change) (int channelNums);
	/* Dynamic */
